...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/:chatId', component: _Chat2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _layoutHelper = __webpack_require__(249);
	...
	socket.on(_socketConstants.New_chat, function (chat) {
	  ...
	  switch (action.type) {
	    ...
	    case _actions.CHAT_UPDATE:
	      return state.map(function (chat, index) {
	        if (action.chatId === chat.chatId) return _extends({}, chat, action.change);
	        return chat;
	      });
	    default:
	      return state;
...
/***/ function(module, exports) {
	...
	var AddChat = exports.AddChat = function AddChat(data) {
	  return _extends({ type: ADD_CHAT }, data);
	};

	var AddMessage = exports.AddMessage = function AddMessage(data) {
	  return _extends({ type: ADD_MESSAGE }, data);
	};
	...
	var UpdateStatus = exports.UpdateStatus = function UpdateStatus(data) {
	  return _extends({ type: CHAT_UPDATE }, data);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = module.exports = __webpack_require__(255).bind(null, Request);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getMessages = function getMessages(id) {
	  return new Promise(function (resolve, reject) {
	    _superagent2.default.get('http://localhost:3001/get-messages/' + id).end(function (err, res) {
	      if (err) reject(err);else resolve(res.body);
	    });
	  });
	};
	...
	var Chat = function (_React$Component) {
	  ...
	  _createClass(Chat, [{
	    ...
	    value: function componentDidMount() {
	      var id = this.props.params.chatId;
	      getMessages(id).then(function (messages) {
